...
DEFAULT_EXCHANGE = "TradeOrge"  # default exchange should ideally provide historical rates
...
class TradeOrge(ExchangeBase):

    async def get_rates(self, ccy):
        json = await self.get_json('tradeorge.com', '/api/v1/markets')
        print(dict([(ccy.upper(), Decimal(d['value']))
